				    ...
				    <!--         </div>		          -->
						      ...
						      <div class="form-group" style="overflow:hidden">									
							   ...
							   1.正常情况下请联系上家进行充值。</b><br />
					        	2.上家被封禁的情况下可选择在线充值。</b><br />
					        	3.上家如若连续7天未登录平台可选择在线充值。</b><br />
					        	4.站长直属下级可直接使用，无上面限制。
				               </div>		          
		           ...
		           <div class="card-header">	
         		      ...
         		      <div class="table-responsive"> 
				         ...
				         <table class="table table-striped">
				          <thead><tr><th>用户UID</th><th>金额</th><th>支付时间</th><th>状态</th></thead>
				          <tbody>				          	
							<?php 
	                     	 $a=$DB->query("select * from qingka_wangke_km where uid='$uid' and status='1' ");
	                     	 while($rs=$DB->fetch($a)){
	                     	     if ($rs['status'] == 1) {
