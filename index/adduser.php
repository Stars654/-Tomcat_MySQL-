			...
			<div class="layui-form-item">
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="text" class="layui-input" placeholder="请输入代理昵称" autocomplete="off" name="name">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">代理邮箱</label>
					<div class="layui-input-inline">
						<input type="text" class="layui-input" placeholder="请输入代理邮箱" autocomplete="off" name="user">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">代理密码</label>
					<div class="layui-input-inline">
						<input type="text" class="layui-input" placeholder="请重新输入代理密码" autocomplete="off" name="pass">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
				    ...
				    <div class="layui-input-inline">
						<button class="layui-btn" type="button" @click="adduser()">
			...
			adduser:function(){
               ...
               $.post("/apisub.php?act=adduser",{data:$("#form-adduser").serialize()},function (data) {
	             ...
	             if (data.code==1){    				
    				...
    				var load = layer.load(2);
    				$.post("/apisub.php?act=adduser",{data:$("#form-adduser").serialize(),type:1}, {emulateJSON: true}).then(function(data) {
    					layer.close(load);
    					if (data.code == 1) {
